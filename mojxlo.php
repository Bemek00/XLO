    ...
    <body>
        ...
        <div id="srodek2">
            <div class="kontent">
                ...
                <div class="zarzogl">
                    <div class="menuogl">
                        <button id="kliknieteogl"> Aktywne </button>
                        <button id="niekliknieteogl" onclick="location.href='zakonczone.php';"> Zakonczone </button>
                        <hr>
                    </div>
                    <div class="menunazwa">
                        Aktywne ogloszenia 
                    ...
                    $zap1 = mysqli_query($polacz, "SELECT tytul, cena, zdjcie, id_ogloszenia FROM ogloszenia WHERE id_uzytkownika = $iduzytkownika AND stan='aktywny'");
                    ...
                    echo "<div class='aktogl'>";
                        ...
                        echo "<div class='guzikogl'>";
                            echo "<form method='post'>";
                                echo "<button name='zakoncz' class='guzaktywuj'> Zakończ </button>";
                    ...
                    if(isset($_POST['zakoncz']))
                    {
                        ...
                        mysqli_query($polacz, "UPDATE ogloszenia SET stan = 'zakonczony' WHERE id_ogloszenia = $idogloszenia");
